      ...
      <section className="landing-grid relative overflow-hidden">
        ...
        <header className="relative z-10 mx-auto flex h-[76px] max-w-7xl items-center justify-between px-5 sm:px-7">
          ...
          <div className="hidden items-center gap-3 md:flex">
            <Button variant="ghost" className="font-bold text-[#24446f]" onClick={() => startLogin()}>Sign in</Button>
            <Button className="pressable rounded-xl bg-[#0d2c58] px-5 font-bold shadow-[0_10px_24px_-14px_rgba(13,44,88,.9)] hover:bg-[#12386d]" onClick={() => startLogin()}>
        ...
        {mobileOpen && <div className="relative z-20 mx-5 mb-4 rounded-2xl border border-[#dce6f3] bg-white p-4 surface-shadow md:hidden"><div className="grid gap-1 text-sm font-bold"><a className="rounded-lg px-3 py-2" href="#how-it-works">How it works</a><a className="rounded-lg px-3 py-2" href="#why-job-sarthi">Why Job Sarthi</a><button className="rounded-lg bg-[#edf4fb] px-3 py-2 text-left" onClick={() => startLogin()}>Sign in to continue</button></div></div>}
